                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="login_Shop">
                                                        ...
                                                        <?php $i++?>
                                                              ...
                                                              <tr style="width: 100%">
                                                                <td style="width: 20%">
                                                                    ...
                                                                    <img src="<?php echo $key->product_image ?>" width="300">
                                                                ...
                                                                <td style="width: 50%">
                                                                    ...
                                                                    <p style="color: #000000">รายละเอียดสินค้า&nbsp;:&nbsp;
                                                                    {{$key->product_detail}}</p>
                                                                    <p style="color: #000000">รีวิวจากลูกค้า&nbsp;:&nbsp;
                                                                    </p>
