            ...
            <div id="content">
                ...
                <div class="container my-auto">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0" style="color: #000000">เพิ่มสินค้า</h1>
                                                    ...
                                                    <form method="post" enctype="multipart/form-data" action="addproduct"  >
                                                        ...
                                                        <div class="form-group row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    name="product_name"  value="" required autofocus>
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <textarea  placeholder="กรุณาใส่รายละเอียดสินค้า..." id="name" type="text" rows="5" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="product_detail"  value="" required autofocus></textarea>
                                                            </div>
                                                    </div>
